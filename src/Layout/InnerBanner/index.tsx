              ...
              <Tab.Pane eventKey="Hotels">
                ...
                >
                  <div className={`${styles.SearchCardBlockLeft} d-md-flex`}>
                    ...
                    <div
                      className={`${styles.FormCard} ${styles.FrmWd4} ${styles.FrmWd5} ${styles.Bdr0} ${styles.FrmWd11}`}
                    >
                      <Dropdown>
                        <Dropdown.Toggle
                          id="TravellersDropdown"
              ...
              <Tab.Pane eventKey="Car">
                ...
                >
                  <div className={`${styles.SearchCardBlockLeft} d-md-flex`}>
                    ...
                    >
                      <div className={`${styles.FrmWdDT1} ${styles.clockIcon}`}>
                        <Form>
                      ...
                      <div className={`${styles.FrmWdDT2} ${styles.clockIcon}`}>
                        <Form>
