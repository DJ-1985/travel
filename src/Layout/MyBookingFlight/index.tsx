          ...
          <Col lg={3}>
            <div className={styles.userDtlProfile}>
              <Nav as="ul" className={styles.myAccountNav}>
                ...
                <Nav.Item as="li" className={`${styles.subNav} ${isOpen ? styles.openNav : ""}`}>
                  <Nav.Link href="#">
                  ...
                  >
                    ...
                    <div className={styles.bkgCard}>
                      <div className={styles.bkgCardTop}>
                        ...
                        <div className={`${styles.bkgStatus} ${styles.statusUpcoming}`}>
                          Upcoming
                        </div>
                      </div>
                      <div className={styles.bkgCardMid}>
...
export default MyBookingFlightPage;
